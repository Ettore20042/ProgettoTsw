    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            ...
            if(brandIdParam != null){
                ...
                request.setAttribute("brandId", Integer.parseInt(brandIdParam));
                dispatcher = request.getRequestDispatcher("/WEB-INF/jsp/products/ProductsList.jsp");
                ...
                request.setAttribute("productList", productList);
                dispatcher = request.getRequestDispatcher("/WEB-INF/jsp/products/Offers.jsp");
                dispatcher.forward(request, response);
            }
