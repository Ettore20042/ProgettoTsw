...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/products/productPage.css">
</head>
<body>
    ...
    <main class="product-page">
        ...
        <jsp:include page="../components/products/_productCard.jsp"/>
    </main>
