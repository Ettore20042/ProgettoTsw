...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/cart/checkout.css" type="text/css">
    <script src="${pageContext.request.contextPath}/Js/cart/checkout.js" defer></script>
</head>
