...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/pages/manage.css">

    <!-- Prima carichiamo BaseManager, poi Manage.js, infine i manager specifici -->
    <script src="${pageContext.request.contextPath}/Js/admin/Manage.js" defer></script>
    <script src="${pageContext.request.contextPath}/Js/admin/managers/ProductManager.js" defer></script>
    <script src="${pageContext.request.contextPath}/Js/admin/managers/UserManager.js" defer></script>
    <script src="${pageContext.request.contextPath}/Js/admin/managers/CategoryManager.js" defer></script>
    <script src="${pageContext.request.contextPath}/Js/admin/managers/BrandManager.js" defer></script>
    ...
    <c:if test="${entity == 'products'}">
        ...
        <script src="${pageContext.request.contextPath}/Js/admin/adminFilterUpdater.js" defer></script>
    </c:if>
</head>
