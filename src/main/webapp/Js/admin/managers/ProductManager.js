...
class ProductManager extends BaseManager {
    ...
    async addProduct(form) {
        try {
            ...
            const url = `${this.contextPath}/ManageProductServlet`;
    ...
    async updateProduct(form) {
        try {
            ...
            const formData = new FormData(form);
            const url = `${this.contextPath}/ManageProductServlet?azione=confermaModifica&id=${productId}`;
    ...
    addRemoveEventListener(button) {
        button.addEventListener('click', async (e) => {
            ...
            try {
                ...
                const url = `${this.contextPath}/ManageProductServlet?productId=${encodeURIComponent(productId)}`;
    ...
    async loadProductForEdit(productId) {
        try {
            const url = `${this.contextPath}/ManageProductServlet?productId=${productId}`;
